...
public class DlgHexagon extends JDialog {
				...
				btnOk.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						try {
							...
							hexagon = new HexagonAdapter(new Point(newX, newY), newRadius,innerColor, edgeColor,false);
							dispose();
						} catch (Exception ex) {
							JOptionPane.showMessageDialog(null, "You have entered incorrect informations!", "ERROR!", JOptionPane.ERROR_MESSAGE);
						}
	...
	public void setHexagon(HexagonAdapter hexagon) {
		txtX.setText("" + hexagon.getXCoordinate());
		txtY.setText("" + hexagon.getYCoordinate());
