...
public class Line extends Shape {
	...
	public String toString() {
		return "Line:start"+"["+this.getStartPoint().getX()+","+this.getStartPoint().getY()+"]"+",end"+"["+this.getEndPoint().getX()+","+this.getEndPoint().getY()+"],"+"foreground["+getColor().getRed()+"."+getColor().getGreen()+"."+getColor().getBlue()+"]";
	}
	
	@Override
	public Line clone() {
		return new Line(new Point(this.getStartPoint().getX(), this.getStartPoint().getY()), 
				new Point(this.getEndPoint().getX(), this.getEndPoint().getY()), true, this.getColor());
