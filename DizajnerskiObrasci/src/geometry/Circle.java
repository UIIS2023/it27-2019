...
public String toString() {
	...
	return "Circle:center"+"["+this.getCenter().getX()+","+this.getCenter().getY()+"]"+",radius("+radius+"),"+"foreground["+getColor().getRed()+"."+getColor().getGreen()+"."+getColor().getBlue()+"]"+","+"background["+getInnerColor().getRed()+"."+getInnerColor().getGreen()+"."+getInnerColor().getBlue()+"]";
}

@Override
public Circle clone() {
	return new Circle(new Point(this.getCenter().getX(), this.getCenter().getY()), 
			this.getRadius(), true, this.getColor(), this.getInnerColor());
